...
from model import DecomNet, EnhModule
import torch
...
def parse_opt(known=False):
    ...
    parser.add_argument('--test_data', type=str, default='datasets/test_set/low-light/LOL_15', help='train set path')
